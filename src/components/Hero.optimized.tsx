  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-warm-white via-cherry-pink-50 to-sakura-100 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="cherry-blossom absolute top-5 left-[25%] [animation-delay:1s]"></div>
        <div className="cherry-blossom absolute top-12 left-[40%] [animation-delay:2s]"></div>
        <div className="cherry-blossom absolute top-8 left-[55%] [animation-delay:3s]"></div>
        <div className="cherry-blossom absolute top-16 left-[70%] [animation-delay:4s]"></div>
        <div className="cherry-blossom absolute top-10 left-[85%] [animation-delay:5s]"></div>
        <div className="cherry-blossom absolute top-20 left-[15%] [animation-delay:1.5s]"></div>
        <div className="cherry-blossom absolute top-24 left-[30%] [animation-delay:2.5s]"></div>
        <div className="cherry-blossom absolute top-16 left-[45%] [animation-delay:3.5s]"></div>
        <div className="cherry-blossom absolute top-28 left-[60%] [animation-delay:4.5s]"></div>
        <div className="cherry-blossom absolute top-20 left-[75%] [animation-delay:5.5s]"></div>
        <div className="cherry-blossom absolute top-32 left-[90%] [animation-delay:6s]"></div>
        <div className="cherry-blossom absolute top-6 left-[5%] [animation-delay:2.2s]"></div>
        <div className="cherry-blossom absolute top-14 left-[20%] [animation-delay:3.3s]"></div>
        <div className="cherry-blossom absolute top-[22px] left-[35%] [animation-delay:4.4s]"></div>
        <div className="cherry-blossom absolute top-[18px] left-[50%] [animation-delay:5.5s]"></div>
        <div className="cherry-blossom absolute top-[26px] left-[65%] [animation-delay:6.6s]"></div>
        <div className="cherry-blossom absolute top-10 left-[80%] [animation-delay:7.7s]"></div>
        <div className="cherry-blossom absolute top-16 left-[95%] [animation-delay:8.8s]"></div>
        <div className="cherry-blossom absolute top-[30px] left-[10%] [animation-delay:9.9s]"></div>
      ...
      <div className="absolute top-3/4 right-5 w-3 h-3 bg-sakura-400 rounded-full opacity-40 animate-ping [animation-delay:1s]"></div>
      <div className="absolute top-1/2 left-1/4 w-1 h-1 bg-cherry-pink-300 rounded-full opacity-80 animate-ping [animation-delay:0.5s]"></div>
    </section>
  )
}
