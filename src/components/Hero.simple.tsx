...
const Hero = ({ dict }: HeroProps) => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-warm-white via-cherry-pink-50 to-sakura-100 overflow-hidden">
      {/* Simplified Background with Image-based Blossoms */}
      ...
      {/* Simplified cherry blossoms */}
      <div className="absolute top-1/4 left-10 text-4xl animate-bounce" style={{animationDuration: '4s'}}>🌸</div>
      <div className="absolute top-1/3 right-10 text-3xl animate-bounce" style={{animationDuration: '3s', animationDelay: '1s'}}>🌸</div>
      <div className="absolute bottom-1/4 left-1/4 text-5xl animate-bounce" style={{animationDuration: '5s', animationDelay: '0.5s'}}>🌸</div>
      <div className="absolute top-1/2 right-1/4 text-4xl animate-bounce" style={{animationDuration: '4.5s', animationDelay: '1.5s'}}>🌸</div>
      <div className="absolute bottom-1/3 left-1/2 text-3xl animate-bounce" style={{animationDuration: '3.5s', animationDelay: '2s'}}>🌸</div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-9xl font-black mb-8 leading-tight animate-fade-in font-japanese tracking-tight" style={{
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
          {[
            ...
            <div key={index} className="text-center bg-white/30 backdrop-blur-md rounded-2xl p-6 border border-white/40 hover:bg-white/40 transition-all duration-300 shadow-lg hover:shadow-xl" style={{
              ...
              <div className="text-3xl md:text-4xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300" style={{
                backgroundImage: 'linear-gradient(135deg, #dc2626, #f87171, #fda4af)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
      ...
      <div className="absolute top-3/4 right-5 w-3 h-3 bg-sakura-400 rounded-full opacity-40 animate-ping" style={{animationDelay: '1s'}}></div>
      <div className="absolute top-1/2 left-1/4 w-1 h-1 bg-cherry-pink-300 rounded-full opacity-80 animate-ping" style={{animationDelay: '0.5s'}}></div>
    </section>
  )
}
